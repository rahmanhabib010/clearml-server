...
class PublicProjectExists(BaseError):
    _default_code = 400
    _default_subcode = 414
    _default_msg = "Cannot create project. public project with the same name already exists"
...
class InvalidContainerId(BaseError):
    _default_code = 400
    _default_subcode = 1050
    _default_msg = "Invalid container id"


class ContainerNotRegistered(BaseError):
    _default_code = 400
    _default_subcode = 1051
    _default_msg = "Container is not registered"


class NoContainersForUrl(BaseError):
    _default_code = 400
    _default_subcode = 1052
    _default_msg = "No container instances found for service url"
